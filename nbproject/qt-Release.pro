...
SOURCES += MainWindow.cpp.cc main.cpp
...
LIBS += -Wl,-rpath,/usr/local/lib /usr/local/lib/libQt5GStreamer-1.0.so -Wl,-rpath,/usr/local/lib /usr/local/lib/libQt5GStreamerUi-1.0.so  
